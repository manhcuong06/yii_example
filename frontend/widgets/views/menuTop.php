<header id="top" class="cd-main-header">
	<a class="cd-logo" href="#0"><img src="/public/img/icon/cd-logo.svg" alt="Logo"></a>
			...
			<ul class="cd-nav-gallery is-hidden">
				...
				<li>
					<a class="cd-nav-item" href="http://codyhouse.co/?p=409">
						<img src="/public/img/icon/img.jpg" alt="Product Image">
						<h3>Product #1</h3>
					</a>
				</li>
